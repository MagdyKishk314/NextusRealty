...
export const faqs: Faq[] = [
  {
    q: "Are Nextus leads really different from typical vendor leads?",
    a: "Yes. Every lead is exclusive to you, verified for real contact details, and, most importantly, cold-called and confirmed by our lead manager before delivery. You receive people our team has already spoken with, not raw form-fills shared with a dozen other agents.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. If a delivered lead is fake, unreachable, or clearly outside the market you signed up for, we replace it, no questions, no runaround. You get real opportunities, not noise.",
  },
  {
